...
1. laboratory and free-living studies to identify the physical activity and healthy physical fitness indicators of importance for medical and predictive use, employing the wearable device and the methodology proposed in the national IMPaCT cohort;

2. the development of mathematical algorithms using massive data processing and pattern-detection techniques;
...
The project is aligned with the IMPaCT cohort in Spain, and is a pilot study orinted to this in the aspect of [acceleromtry protocol]().
